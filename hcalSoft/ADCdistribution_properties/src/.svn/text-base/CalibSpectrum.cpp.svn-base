...
CalibSpectrum::CalibSpectrum(int chipID, int chn, int vCalib) {
	...
	histoAll = new TH1F(TString::Format("z_ADC_chip%d_chn%d_%d",chipID, chn, vCalib),TString::Format("ADC Spectrum Chip %d, Channel %d, Hold#_{value} %d",chipID, chn, vCalib),4096,-0.5,4095.5);
